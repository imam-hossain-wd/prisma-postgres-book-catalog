...
router.post('/create-order', (0, validationRequest_1.default)(orderValidation_1.OrderValidation.createOrderZodSchema), order_controller_1.orderController.createOrder);
