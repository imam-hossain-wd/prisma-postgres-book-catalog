...
router.get('/my-orders', order_controller_1.orderController.getMyOrder);
...
router.get('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), order_controller_1.orderController.getSingleOrder);
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), order_controller_1.orderController.updateOrder);
